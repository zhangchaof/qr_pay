...
import com.exam.demo.model.alipay.AliPayConfig;
...
public class QRPayController {
    ...
    private String prefixHttp = AliPayConfig.prefixHttp;

    private String wechatPayNotifyUrl = prefixHttp + "/notify/wechat.html";
    private String aliPayNotifyUrl = prefixHttp + "/notify/alipay.html";
    private String aliPayReturn = prefixHttp + "/return/alipay.html";
    ...
    public Map<String, Object> preOrder() {
        ...
        result.put("oid", oid);
        result.put("prefixHttp", prefixHttp);
        return result;
    }
    ...
    public ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Map<String, Object> map) {
        ...
        if (userAgent.toLowerCase().contains("MicroMessenger".toLowerCase())) {
            ...
            String openid = handleWechatBrow(request, response, prefixHttp + "/pay/qr");
